...
import com.fit.service.im.IQgroupService;
import com.fit.service.im.QgroupService;
...
public class QgroupController extends IController {
    ...
    public Object list(Page page) throws Exception {
        ...
        page.setPd(pd);
        List<PageData> resultList = qgroupService.listPage(page);    //列出Qgroup列表
