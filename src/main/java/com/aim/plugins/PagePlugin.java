package com.aim.plugins;

import com.aim.entity.Page;
import com.aim.util.ReflectHelper;
        ...
        if (ivk.getTarget() instanceof RoutingStatementHandler) {
            ...
            if (mappedStatement.getId().matches(pageSqlId)) {
                ...
                if (parameterObject == null) {
                    ...
                    String countSql = "select count(0) from (" + sql + ") as tmp_count"; //记录统计 == oracle 加 as 报错(SQL command not properly ended)
