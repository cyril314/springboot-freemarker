package com.aim.plugins.websocket;

import com.aim.plugins.websocket.instantMsg.ChatServer;
import com.aim.plugins.websocket.online.OnlineChatServer;
import com.aim.util.Const;
import com.aim.util.IniFileUtil;
import com.aim.util.PathUtil;
...
public class StartWebsocketServer implements ApplicationRunner {
    ...
    public void startWebsocketOnline() {
        ...
        try {
            ...
            String onlinePort = IniFileUtil.readCfgValue(infFilePath, "SysSet1", "onlinePort", "8839");//在线管理端口
    ...
    public void startWebsocketInstantMsg() {
        ...
        try {
            String infFilePath = PathUtil.getClasspath() + Const.SYSSET;    //配置文件路径
            String imPort = IniFileUtil.readCfgValue(infFilePath, "SysSet1", "imPort", "8829");//即时通讯端口
