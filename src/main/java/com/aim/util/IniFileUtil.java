...
public class IniFileUtil {
    ...
    public static String readCfgValue(String file, String section, String variable, String defaultValue)
        ...
        try {
            while ((strLine = bufferedReader.readLine()) != null) {
                ...
                // 判断是否包含要修改的变量
                isInSection = judgeIncludes(strLine, section);
                if (isInSection == true) {
                    strLine = strLine.trim();
    ...
    private static boolean judgeIncludes(String strLine, String section) {
        Pattern p = Pattern.compile("\\[\\w+]");// Pattern.compile("file://[//s*.*//s*//]");
