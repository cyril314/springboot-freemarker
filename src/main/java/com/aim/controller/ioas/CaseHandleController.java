package com.aim.controller.ioas;

import org.activiti.engine.FormService;
import org.activiti.engine.RepositoryService;
import org.activiti.engine.RuntimeService;
import org.apache.shiro.authz.annotation.RequiresPermissions;
import com.aim.controller.act.AcStartController;
import com.aim.entity.Page;
import com.aim.entity.PageData;
import com.aim.service.oa.CaseHandleService;
...
//			formService.submitStartFormData(processDefinition.getId(),testmap);
    ...
    public Object list(Page page) throws Exception {
        ...
        page.setPd(pd);
        List<PageData> varList = caseHandleService.listPage(page);    //列出Myleave列表
