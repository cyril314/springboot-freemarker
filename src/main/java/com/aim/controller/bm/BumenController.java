...
public class BumenController extends IController {
    ...
    public Object list(Page page) throws Exception {
        ...
        page.setPd(pd);
        List<PageData> varList = bumenService.listPage(page);            //列出Bumen列表
    ...
    public Object listTree() throws Exception {
        Map<String, Object> map = new HashMap<String, Object>();
        String errInfo = "success";
        JSONArray arr = FastJsonUtil.objParseJsonArray(bumenService.listTree("0"));
