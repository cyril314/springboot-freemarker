 ...
 * 流程管家总类
 */
public class AcBaseController extends IController {
    ...
    protected String deploymentProcessDefinitionFromModelId(String modelId) throws Exception {
         ...
         * [test] 和表单一起部署
         */
        String formName = "form/" + modelData.getName() + ".form";
        deploymentBuilder.addString(formName, new String(bpmnBytes, "utf-8"));
