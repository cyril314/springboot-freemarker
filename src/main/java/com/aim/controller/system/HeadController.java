...
import com.aim.plugins.mail.SimpleMailSender;
import com.aim.service.system.PhotoService;
...
@Controller
@RequestMapping("/head")
public class HeadController extends IController {
    ...
    public Object getList() throws Exception {
        ...
        if (null != user) {
            ...
            map.put("smsSound", IniFileUtil.readCfgValue(infFilePath, "SysSet1", "smsSound", "1"));                    //信息提示音

            Object RNUMBERS = Jurisdiction.getRnumbers();
            if (null == RNUMBERS) {
    ...
    public Object sysSet() throws Exception {
        ...
        pd.put("smsSound", IniFileUtil.readCfgValue(infFilePath, "SysSet1", "smsSound", "m1"));                //信息提示音
    ...
    public Object saveSysSet() throws Exception {
        ...
        String smsSound = pd.getString("smsSound");                    //信息提示音
        ...
        IniFileUtil.writeCfgValue(infFilePath, "SysSet1", "smsSound", smsSound);
