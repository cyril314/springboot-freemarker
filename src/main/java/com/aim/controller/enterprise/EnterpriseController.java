...
public class EnterpriseController extends IController {
    ...
    public Object list(Page page) throws Exception {
        ...
        page.setPd(pd);
        List<PageData> varList = enterpriseService.listPage(page);    //列出Enterprise列表
