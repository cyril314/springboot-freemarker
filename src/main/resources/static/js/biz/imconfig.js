layui.config({
    base: '/plugins/layui/js/' //扩展 JS 所在目录
}).extend({
    readyMenu: 'readyMenu'
});
...
layui.use(['layim', 'readyMenu'], function () {
    console.log("-  - 访问layim -  - ");
    ...
    function applyIFriend() {
        layim.msgbox('新');
        $("#smsobj").html('<audio style="display: none;" id="fhsmstsy" src="/assets/sound/' + fhsmsSound + '.mp3" autoplay controls></audio>');
    }
